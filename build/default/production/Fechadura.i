...
void teclado1(void) {
    ...
    do {
        ...
        if (kpRead() != temp) {
            ...
            if (((kpRead()) & (1<<(3))) || ((kpRead()) & (1<<(2))) || ((kpRead()) & (1<<(1))) || ((kpRead()) & (1<<(4))) || ((kpRead()) & (1<<(5))) || ((kpRead()) & (1<<(6))) || ((kpRead()) & (1<<(7))) || ((kpRead()) & (1<<(9))) || ((kpRead()) & (1<<(10))) || ((kpRead()) & (1<<(11)))) {
                i++;
...
void defineSenha(void) {
    ...
    do {
        ...
        if (kpRead() != temp) {
            ...
            if (((kpRead()) & (1<<(3))) || ((kpRead()) & (1<<(2))) || ((kpRead()) & (1<<(1))) || ((kpRead()) & (1<<(4)))
                    || ((kpRead()) & (1<<(5))) || ((kpRead()) & (1<<(6))) || ((kpRead()) & (1<<(7)))
                    || ((kpRead()) & (1<<(9))) || ((kpRead()) & (1<<(10))) || ((kpRead()) & (1<<(11)))) {
                i++;
